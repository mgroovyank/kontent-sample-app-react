...
It includes integration sample for HubSpot Forms using data from [HubSpot Form selector](https://github.com/Kentico/cloud-custom-element-sample-hubspot).
...
![Analytics](https://kentico-ga-beacon.azurewebsites.net/api/UA-69014260-4/Kentico/cloud-sample-app-react/samples/hubspot?pixel)
